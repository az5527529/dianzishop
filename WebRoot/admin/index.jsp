...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top" style="color:#000;">
    <h1><img src="images/y.jpg" class="radius-circle rotate-hover" height="50" alt="" /> 图书购物系统  </h1>
  </div>
  <div class="head-l"><a class="button button-little bg-green" href="http://localhost:8080/dianzishop/showIndex.do" target="_blank"><span class="icon-home"></span> 前台首页</a> &nbsp;&nbsp;
